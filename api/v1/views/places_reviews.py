...
def review_create(place_id):
    """
    creates rview route
    returns the created Review obj
    """
...
def review_by_id(review_id):
    ...
    returns review obj with the specified id or error
    """

    fetched_data = storage.get("Review", str(review_id))
...
def review_put(review_id):
    ...
    returns Review object and 200 on success, or 400 or 404 on failure
    """
